...
pub fn build(
    ...
    Ok(Router::new()
        ...
        .route("/api/skills/{name}/versions", get(handlers::list_skill_versions))
        .route("/api/skills/{name}/snapshot", post(handlers::snapshot_skill_version))
        .route("/api/skills/{name}/rollback", post(handlers::rollback_skill_version))
        ...
        .route("/api/personas/{id}", put(handlers::update_specialist_persona))
